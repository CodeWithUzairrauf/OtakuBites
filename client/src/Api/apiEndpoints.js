...
// Body: { password }
const resetPasswordURL = "/api/auth/reset-password/:token";
...
// GET /api/communities
const getCommunitiesURL = "/api/communities";

// Create a new community (private)
// POST /api/communities
// Body: { name, description, image }
// Header: Authorization: Bearer <token>
const createCommunityURL = "/api/communities";

// Join a community (private)
// POST /api/communities/:id/join
// Header: Authorization: Bearer <token>
const joinCommunityURL = "/api/communities/:id/join";

// Leave a community (private)
// POST /api/communities/:id/leave
// Header: Authorization: Bearer <token>
const leaveCommunityURL = "/api/communities/:id/leave";
...
const getCommentsURL = "/api/posts/:postId/comments";

// Create a comment on a post (private)
// POST /api/posts/:postId/comments
// Body: { content, parentId? } // parentId for reply
// Header: Authorization: Bearer <token>
const createCommentURL = "/api/posts/:postId/comments";

// Delete comment by ID (private, author or community admin)
// DELETE /api/posts/comments/:commentId
// Header: Authorization: Bearer <token>
const deleteCommentURL = "/api/posts/comments/:commentId";